...
async def debug_import_errors():
    ...
    modules_to_test = [
        "config", "utils.logging", "utils.security", "utils.benchmarking",
        "database.db_manager", "git_backup.backup", "agent.living_mind",
        "agent.sacred_reader", "agent.book_reader", "agent.memory",
        "api.chat", "api.books", "api.status", "api.art",
