...
# ============================================================
# القرآن يُحمّل تلقائياً من رابط JSON
# لا حاجة لرفع أي ملفات
# ============================================================
...
async def startup_event():
    ...
    logger.info("=" * 60)
    logger.info("🚀 تشغيل الحارس الصامت – تحميل القرآن من الرابط")
    logger.info("=" * 60)
    ...
    # ============================================================
    # تحميل القرآن الكريم من الرابط (JSON)
    # ============================================================
    constitution_text = ""
    
    # 1. حاول قراءة من قاعدة البيانات أولاً (سريع)
    ...
    if not constitution_text:
        ...
        try:
            ...
            # حفظ في قاعدة البيانات للاستخدامات القادمة
            db.execute(
            ...
            logger.error(f"❌ فشل تحميل القرآن من الرابط: {e}")
    
    # ============================================================
    # إذا نجح التحميل، احفظ في Persistent Disk (كد بديل)
    # ============================================================
    if constitution_text:
        with open(CONSTITUTION_FILE, 'w', encoding='utf-8') as f:
            f.write(constitution_text)
        logger.info(f"💾 تم حفظ الدستور في {CONSTITUTION_FILE}")
    ...
    # ============================================================
    if not constitution_text:
        logger.error("❌ فشل تحميل الدستور! تأكد من اتصال الإنترنت")
        ...
        <div class="chat-messages" id="messages">
            <div class="message agent-message">
                <div class="message-bubble">
                    السلام عليكم. {'الدستور مرتفع (' + length_display + ' حرفاً). مزاجي: ' + mood_name + '. الكتاب الحالي: ' + current_book + '. اسألني ما شئت.' if constitution_status == 'مرتفع' else 'جاري تحميل الدستور... يرجى الانتظار لحظة.'}
                </div>
            </div>
        </div>
...
async def constitution_excerpt():
    ...
    if mind and mind.sacred_text:
        return JSONResponse({
            ...
            "source": "Quran JSON (loaded from CDN)"
        })
