...
# 2. التعلم التلقائي من الكتب
# 3. الفضول التلقائي وطرح الأسئلة
# 4. البوابة الدستورية لفحص كل قرار
# 5. التقييم الذاتي وتحسين الأداء
# 6. التعبير البصري عن المزاج عبر SVG
# ============================================================
...
# 🔑 إضافة مسار المشروع لضمان عمل الاستيرادات
...
# 🔑 الإصلاح الأساسي: استخدام المجلد الجديد git_backup
...
class GroqClient:
    """عميل موحد لـ Groq API مع معالجة الأخطاء"""
...
class LivingMind:
    ...
    def __init__(self, constitution_text: str, db=None, 
        ...
        self._log("🚀 الحارس الصامت v5.2 بدأ تشغيله")
